  ...
  _createClass(MotionGlob, [{
    ...
    value: function replaceObjects(way) {
      ...
      if (way == 'next') {
        ...
        if (this.isAcrossBGEdge()) {
          ...
          this.isBGCrossProgress = true; // console.log('Copy element to end')
        ...
        if (this.isAcrossEndEdge()) {
          ...
          this.isENDCrossProgress = true; // console.log('Copy element to start')
    ...
    value: function hoverRemove(context) {
      ...
      context.mousetimer = setTimeout(function () {
        $(context.itemClass).removeClass('-hover-'); // console.log('remove')
      }, 1000);
    }
  }, {
    key: "setEdges",
    ...
    value: function render() {
      ...
      function renderStep() {
        ...
        if (self.hoveringItem != null) {
          self.getEdgesOfHover(); // console.log('Is hovering:', self.isInsiteOfItem())
