...
function setSizes() {
  const contentWidth = $( '.infoItem' ).width();
...
function drawInfoItem( data ) {
  ...
  const workTitle__value = document.createElement( 'h1' );
  ...
  const workLaunch = document.createElement( 'div' );
  $( workLaunch ).addClass( 'paramLine' );
  const workLaunch__title = document.createElement( 'span' );
  $( workLaunch__title ).addClass( 'paramTitle' );
  $( workLaunch__title ).text( 'Launch' );
  const workLaunch__value = document.createElement( 'span' );
  ...
  const workCategory__title = document.createElement( 'span' );
  $( workCategory__title ).addClass( 'paramTitle' );
  $( workCategory__title ).text( 'Category' );
  const workCategory__value = document.createElement( 'span' );
  ...
  const workClient__title = document.createElement( 'span' );
  $( workClient__title ).addClass( 'paramTitle' );
  $( workClient__title ).text( 'Client' );
  const workClient__value = document.createElement( 'span' );
...
function drawVideo( id ) {
  const text_elem = $.parseHTML( videoObj[ id ].src )[ 0 ].data;
...
$( document ).delegate( '.vjs-play-control, .vjs-tech, .vjs-big-play-button', 'click', () => {
  if ( player.paused() ) {
